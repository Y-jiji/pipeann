// SPACEV-200M PipeANN two-phase bench, ported from fnct-bench's Bench
// harness (see fnct-db/evaluation/hermes_spacev.rs for the reference shape).
//
...
//
// Data/queries are raw flat files (no header), dtype int8_t, dim 100.
